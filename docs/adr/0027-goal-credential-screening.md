...
Direct IAM Runtime/CLI calls, stored sessions, retrieved content, memory, and
model output are outside this check. Content tracing still requires restricted
access, short retention, and non-sensitive inputs. Existing data is not scrubbed.
